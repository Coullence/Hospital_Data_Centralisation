                        ...
                        <div class="card-body">
                           <form id="form_validation" method="POST" action="{{ route('users.store') }}">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control @error('hospital') is-invalid @enderror" name="hospital" value="{{old('hospital')}}" placeholder="Hospital" required autofocus>
                                    @error('hospital')
                                        <label id="name-error" class="error" for="hospital">{{ $message }}</label>
                                    @enderror
                                </div>
