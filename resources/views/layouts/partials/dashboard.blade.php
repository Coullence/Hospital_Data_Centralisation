...
<<<<<<< HEAD
  ...
  <div class="col-md-6 col-sm-12">
    <div class="card card-stats revoked">
      <div class="card-header">Congratuallations!!!</div>
      <div class="card-body ">
        <p>KIndly wait for the Chief Executive to approve your applications.</p><br>
        <hr>
        <small><i>Processing....</i></small>
=======
  <div class="col-lg-3 col-md-6 col-sm-6">
    <div class="card card-stats">
      <div class="card-body ">
